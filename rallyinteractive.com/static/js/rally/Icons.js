...
function Icons(shot){
	...
	this.__construct__ = function(){
		...
		this.feedback.src = "/static/img/feedback.png";

		this.views = new Image();
		this.views.src = "/static/img/views.png";

		this.likes = new Image();
		this.likes.src = "/static/img/likes.png";
		...
		this.dribbbleLink = new DribbbleLink(this.shot, "View shot on dribbble");
