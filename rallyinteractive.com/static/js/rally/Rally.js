var Rally = function(){
	...
	this.bioClick = function(e){
		...
		if(self.expanded){
			...
			self.bioToggle.style.backgroundImage = "url(/static/img/toggle-down.png)";
			self.bioToggle.innerHTML = "Show Rally Bios";
			self.expanded = false;
		} else {
			...
			self.bioToggle.style.backgroundImage = "url(/static/img/toggle.png)";
			self.bioToggle.innerHTML = "Hide Rally Bios";
			self.expanded = true;
		}
